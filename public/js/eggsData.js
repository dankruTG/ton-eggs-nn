const eggs = [
    ...
    { name: "Topaz Egg", icon: "public/images/secretEggs/topazEgg.png", rarity: "Secret", strength: 2500, minting: "no" },
    { name: "Golden Egg", icon: "public/images/uncommonEggs/goldenEgg.png", rarity: "Rare", strength: 1000, minting: "no" },
    { name: "Opal Egg", icon: "public/images/rareEggs/opalEgg.png", rarity: "Rare", strength: 1000, minting: "no" },
